<template>
  ...
  <div class="container">
    <h4 class="text-center">請填寫收件人資料</h4>
    <h4 class="mb-4 font-mirza text-center">Info</h4>
    <div class="row">
      <Form v-slot="{ errors }" @submit="createOrder" class="col-11 col-md-8 mx-auto shadow p-4 bg-light rounded">
        <div class="mb-3">
