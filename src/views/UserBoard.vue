  ...
  <div class="wrap">
    <nav class="navbar navbar-expand-md pb-0">
      <div class="container-fluid flex-wrap">
        ...
        <router-link to="/" class="navbar-brand flex-grow-1 flex-md-grow-0 p-0">
    ...
    <footer class="bg-light d-flex flex-column justify-content-center py-3">
      ...
      <p class="text-center text-secondary m-0">僅個人作品使用，無任何商業用途 |
